    ...
    <div dir="rtl" className="app-scroll" style={{ background: "#FAF7F2", padding: "20px 20px 60px" }}>
      ...
      <main style={{ maxWidth: 680, margin: "0 auto", background: "white", borderRadius: 20, padding: "32px 26px", boxShadow: "0 1px 3px rgba(0,0,0,.06)", lineHeight: 1.9, color: "#374151", fontSize: 15 }}>
        ...
        <Section title="اشتراك دفتري">
          ...
          <p style={p}>
            الاشتراك عبر التطبيق يتجدد تلقائياً سنوياً، ويشمل كل أبنائك المسجَّلين ضمن الباقة المختارة. إذا زاد عدد أبنائك عن
        ...
        <Section title="الدفع والتجديد والإلغاء">
          <p style={p}>
            تتم المدفوعات من داخل التطبيق — لاشتراك دفتري ولاشتراك المعلم الذكي — عبر
            {" "}<strong>مشتريات آبل داخل التطبيق</strong>، ولا نستقبل ولا نخزّن أي بيانات بطاقة بنكية.
          </p>
          <ul style={ul}>
            <li style={li}>يُخصم المبلغ من حساب آبل الخاص بك عند تأكيد الشراء.</li>
            <li style={li}>تنطبق البنود التالية على الشراء عبر متجر آبل.</li>
            <li style={li}>
          ...
          <p style={p}>
            <strong>الاسترجاع:</strong> طلبات استرجاع المبالغ المدفوعة عبر متجر آبل تخضع لسياسة آبل وتُقدَّم إليها مباشرة عبر
