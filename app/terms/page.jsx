      ...
      <main style={{ maxWidth: 680, margin: "0 auto", background: "white", borderRadius: 20, padding: "32px 26px", boxShadow: "0 1px 3px rgba(0,0,0,.06)", lineHeight: 1.9, color: "#374151", fontSize: 15 }}>
        ...
        <Section title="اشتراك دفتري">
          ...
          <p style={{ ...p, background: "#FDF3E7", padding: "12px 14px", borderRadius: 12, color: "#8C6027", fontSize: 14 }}>
            <strong>تجربة مجانية {GRACE_LABEL}:</strong> إذا كان حسابك مسجَّلاً قبل تفعيل هذا الاشتراك، يبقى
            استخدامك مجانياً {GRACE_LABEL} من تاريخ التفعيل، مع تنبيه داخل التطبيق بالتاريخ الذي تنتهي فيه
            التجربة. وإذا سجَّلتِ حساباً جديداً بعد التفعيل، تحصلين على نفس المدة من تاريخ تسجيلك أنتِ. بعد
            انتهاء التجربة، يتطلّب الاستمرار في استخدام دفتري اشتراكاً سارياً.
          </p>
        </Section>
