    ...
    <div dir="rtl" style={{ minHeight: "100%", overflowY: "auto", background: "#FAF7F2", padding: "40px 20px 60px" }}>
      <main style={{ maxWidth: 680, margin: "0 auto", background: "white", borderRadius: 20, padding: "32px 26px", boxShadow: "0 1px 3px rgba(0,0,0,.06)", lineHeight: 1.9, color: "#374151", fontSize: 15 }}>
        ...
        <Section title="الاشتراكات والدفع">
          <p style={p}>
            التطبيق مجاني حالياً. في حال إضافة اشتراك مدفوع مستقبلاً، تُعالَج المدفوعات عبر بوابة دفع خارجية معتمدة،
            و<strong>لا نحتفظ بأي بيانات بطاقات بنكية على خوادمنا</strong>. سنحدّث هذه السياسة قبل تفعيل أي خدمة مدفوعة.
          </p>
        </Section>
