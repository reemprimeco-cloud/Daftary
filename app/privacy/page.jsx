    ...
    <div dir="rtl" className="app-scroll" style={{ background: "#FAF7F2", padding: "20px 20px 60px" }}>
      ...
      <main style={{ maxWidth: 680, margin: "0 auto", background: "white", borderRadius: 20, padding: "32px 26px", boxShadow: "0 1px 3px rgba(0,0,0,.06)", lineHeight: 1.9, color: "#374151", fontSize: 15 }}>
        ...
        <Section title="المدفوعات">
          <p style={p}>
            <strong>دفتري</strong> يعمل باشتراك سنوي يغطي الجداول والواجبات والمتطلبات والحفظ والدرجات
            والتذكيرات، بسعر يتناسب مع عدد أبنائك المسجَّلين، ولا يحتوي على أي إعلانات. المعلم الذكي — الشرح
            والإجابة على الأسئلة الدراسية — له اشتراك مستقل اختياري، مع أسئلة مجانية لتجربته أولاً.
          </p>
          <p style={p}>
            <strong>رسوم الاشتراك</strong> مخصَّصة لتغطية تكلفة الذكاء الاصطناعي في معالجة الخطط الأسبوعية وتحليلها،
            وتشغيل التذكيرات — وليست ربحاً.
          </p>
          <p style={{ ...p, background: "#F1EFFA", padding: "12px 14px", borderRadius: 12, color: "#5C4B8C", fontSize: 14 }}>
