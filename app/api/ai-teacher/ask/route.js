...
مهم جداً — المصطلحات: التزمي حرفياً بالمصطلحات والتسميات الموجودة بالمواد الرسمية المرفقة (نماذج الاختبارات وأسماء الكتب) لو كانت متوفرة. لا تستبدلي مصطلح المنهج بمرادف أو تسمية مختلفة حتى لو كانت أدق أو أشيع، لأن الطالب/ة يتعلم وينحل بنفس ألفاظ المنهج بالضبط وأي اختلاف يلخبطه بالاختبار. لو مصطلح معين مب واضح من المرفقات، اذكري إنك غير متأكدة من التسمية الرسمية بدل ما تخمّنين مرادف.
