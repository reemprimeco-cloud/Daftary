...
//
// السعر خطي: ٢ د.ك للطالب الواحد، بسقف عند ٦ طلاب فأكثر — بدون السقف
// نحتاج منتجاً لكل رقم ممكن نظرياً بلا نهاية. لو زاد الطلب على عوائل أكبر
// من ٦ طلاب مستقبلاً، نرفع السقف بإصدار جديد يضيف منتجات إضافية بنفس
// المجموعة (المنتجات الحالية ما تتأثر).
export const APP_PLAN = {
  PRICE_PER_STUDENT_KWD: 2,
  MAX_TIER: 6,
  // تجربة مجانية أسبوع قبل ما يصير الاشتراك إلزامياً — من تاريخ التفعيل
  // للمستخدمين الحاليين، ومن تاريخ التسجيل نفسه للمستخدمين الجدد بعده
  // (التفاصيل بـ lib/appEntitlements.js). ثابت واحد يشاركه الكود وصفحة
  // الشروط عشان ما يصير تعارض بين الاثنين.
  GRACE_DAYS: 7,
};
